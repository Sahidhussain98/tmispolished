...
import com.ehrms.tmis.user.testDto.TrainingAssignmentDTO;
...
public class TrainingAssignmentService {
    ...
    private CalendarDTO convertToCalendarDTO(M_Calendar calendar) {
        ...
        dto.setProgramName(calendar.getProgrameName() != null ? calendar.getProgrameName().getProgramName() : null);
        dto.setTopic(calendar.getTopic() != null ? calendar.getTopic().getTopicName() : null);
